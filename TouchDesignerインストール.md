...
### Derivativeから送られてきたメールを確認し、リンクをクリックする
アカウント作成を確定します。
...
## TouchDesignerのインストーラのダウンロードとインストール
### TouchDesignerのインストーラのダウンロード
...
## ラインセンスのキーの紐づけ解除
ライセンスのアクティベートの解除を行うときは、Key Manager の Disable タブより、Disable Keyを押します。
